                ...
                <div className="w-full flex-wrap p-2 pb-5 m-auto bg-[#B5D5FE] shadow-gray-300  rounded-xl border border-[#0F2650]" style={{ boxShadow: '18px 19px 14px -3px rgba(0,0,0,0.1)', }}>
                    ...
                    {booking ? (
                            <picture className="flex justify-start rounded">
                                <img className='rounded-full aspect-square mx-3 my-2 w-20 h-[78px] border border-[#0F2650]' src={booking.konselor.avatar} />
                            </picture>
                        )
                            : <p>loading</p>
                        }
                        ...
                        {booking ? (
                            <div className='flex flex-col mt-2'>
                                <h1 className="flex mx-3 mt-2 font-bold text-xl">{booking.konselor.nama}</h1>
                                <Spesifikasi />
                            </div>
                        )
                            : <p>loading</p>
