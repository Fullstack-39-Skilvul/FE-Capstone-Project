...
const MediaSesi = () => {
    ...
    return (
        <>
            ...
            <div className='pr-3 pl-2 pb-2 border-b-2 border-r border-blue-700' style={{ boxShadow: '8px 9px 7px -3px rgba(0,0,0,0.1)', }}>
            ...
            <div className='pr-3 pl-2 border-b-2 border-r border-blue-700' style={{ boxShadow: '8px 9px 7px -3px rgba(0,0,0,0.1)', }}>
