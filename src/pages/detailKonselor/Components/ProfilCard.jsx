...
const CardKonselor = () => {
  ...
  return (
    <>
      <div>
        <div
          className="p-4 m-5 w-[240px] bg-[#B5D5FE] shadow-gray-300  rounded-xl border border-[#0F2650]"
        ...
        >
          {konselor ? (
            ...
            <picture className="flex justify-center rounded">
              <Skeleton circle className="w-20 h-[78px]" />
            </picture>
          )}

          {konselor ? (
            <div>
              <h1 className="flex justify-center mt-4 mb-2 mx-3 font-bold text-lg">
                {konselor.nama}
              </h1>
              <Spesifikasi />
            </div>
