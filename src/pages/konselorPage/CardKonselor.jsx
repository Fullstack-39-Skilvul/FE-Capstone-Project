        ...
        {konselor ? (
          konselor.map((item) => {
            return (
              ...
              <div
                key={item._id}
                className="p-4 m-8 w-80 bg-[#F6F6F6] shadow-gray-300  rounded-xl border border-[#0F2650]"
